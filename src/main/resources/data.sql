...
/* 12.編集者テーブル */
INSERT INTO editor_users (eu_code, created_at, updated_at, name, password)
VALUES ('775', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, '山本 浩明', 'yamahiro');

/* 21.設計契約テーブル */
INSERT INTO design_contracts (dc_latest_editor, dc_created_at, dc_updated_at, contract_number, contract_name, customer_name)
